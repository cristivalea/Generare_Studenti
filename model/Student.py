...
class Student(Persoana):
    def __init__(self, sex, varsta):
        ...
        self.__data_inmatricluare = self.data_inmatriculare(date(2020, 1, 1), date(2020, 1, 7))
    ...
    def data_inmatriculare(self, data_start, data_end):
    ...
    def get_data_inmatriculare(self):
        return self.data_inmatriculare
    ...
    def __repr__(self):
        ...
        return f"{persoana_info}, Numar matricol: {self.__nr_matricol}, Data inmatriculare: {self.__data_inmatricluare}"


student1 = Student('M', 20)
print(student1)